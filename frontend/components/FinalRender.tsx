...
const FinalRender: React.FC<FinalRenderProps> = ({ videoUrl, imageUrl, onRestart, hideStatusPanel = false }) => {
  ...
  const MediaPanel = (
    <div className="flex-1 h-full relative bg-black flex items-center justify-center p-4 md:p-8 overflow-hidden">
